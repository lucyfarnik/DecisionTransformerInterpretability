...
from typing import Any, Iterable, SupportsFloat, TypeVar, Literal
...
class MiniGridEnv(gym.Env):
    ...
    def reset(
        ...
        *,
        ...
        target_obj = options['target_obj'] if options is not None and 'target_obj' in options else None
        target_pos = options['target_pos'] if options is not None and 'target_pos' in options else None
        self._gen_grid(self.width, self.height, target_obj, target_pos)
